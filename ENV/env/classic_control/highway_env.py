...
class HighwayEnv(AbstractEnv):
    ...
    def _create_road(self, length = 800):
        """
    ...
    def _create_vehicles(self):
        ...
        # vehicle = other_vehicles_type.create_random(self.road,velocity=-10)
        ...
        for i in range(5):
            self.road.vehicles.append(
                vehicles_type(road,
                              ...
                              .position(200+20*i + 10*self.np_random.randn(), 0),
                              heading=road.network.get_lane(("a", "b", 1)).heading_at(200+100*i),
